...
## ---- fig.width = 5, fig.height = 3--------------------------------------
# selec a couple of locations and plot points on the slope map
loc1 <- 2200
loc2 <- 6200
...
## ---- fig.width = 5, fig.height = 3--------------------------------------
# identify areas of slope > 0.2 and < 0.5
slope_q$safep90 <- NA
slope_q$safep90[slope_q$prob90perc < 0.5 & slope_q$prob90perc > 0.2] <- "good"
slope_q$safep90[is.na(slope_q$safep90)] <- "bad"
slope_q$safep90 <- as.factor(slope_q$safep90)
spplot(slope_q, "safep90", col.regions = c("red","green"), main = "90% certain suitable for skiing")
...
spplot(snow_poly, col.regions = c(transparent_grey, "transparent"),  
       main = "90% certain suitable for skiing and snow presence",
       sp.layout = spl)
