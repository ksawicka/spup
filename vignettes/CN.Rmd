...
We can also view example of C/N realizations at specific locations, for example where it is highiest and lowest:
...
The dataset was derived from ISRIC soilgrid information (Hengl et al., 2017). 
